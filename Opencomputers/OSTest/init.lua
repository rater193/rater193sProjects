do
	local colorBackground = 0x111155
	local colorForeground = 0x5555ff
  ...
  if gpu and screen then
    ...
    component.invoke(gpu, "setBackground", colorBackground)
    component.invoke(gpu, "setForeground", 0xff5500)
  ...
  require("component").gpu.setBackground(colorBackground)
  require("component").gpu.setForeground(colorForeground)
  require("term").clear()
